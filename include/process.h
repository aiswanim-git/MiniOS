...
/*
 * Simulated process manager, modelled on the PCB / process-state ideas
 * from the LA5 reference lab, adapted for a single in-process simulation
 * rather than real fork/exec'd OS processes (out of scope per project
 * requirements: no ELF loading, no real scheduling of OS-level threads).
 *
